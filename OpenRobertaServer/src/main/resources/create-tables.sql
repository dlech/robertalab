...
create unique index toolNameOwnerIdx on TOOLBOX(NAME, OWNER_ID);
...
values ('Standardkonfiguration',NULL,'robot ev3 Standardkonfiguration {  size {    wheel diameter 5.6 cm;    track width    12.0 cm;  }  sensor port {    1: touch;    4: ultrasonic;  }  actor port {    B: large motor, regulated, forward, right;    C: large motor, regulated, forward, left;  }}',
now, now, now, now,
 '', 0
);
commit;
